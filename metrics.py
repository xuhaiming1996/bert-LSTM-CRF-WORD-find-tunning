...
def get_metrics_ops(labels, predictions, num_labels,input_label_mask):
    # 得到混淆矩阵和update_op，在这里我们需要将生成的混淆矩阵转换成tensor
    cm, op = _streaming_confusion_matrix(labels=labels, predictions=predictions,num_classes= num_labels,weights=input_label_mask)
